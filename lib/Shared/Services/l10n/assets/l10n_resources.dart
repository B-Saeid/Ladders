...
abstract class L10nR {
  static final _currentLocale = SupportedLocale.fromLocale(L10nService.localeSettings.locale!);

  /// Toasts
  static String get tThemeChangeCoolDown => switch (_currentLocale) {
        SupportedLocale.en => 'Theme change cooling down',
        SupportedLocale.ar => 'تغيير سمة الجهاز قيد الانتظار',
      };

  static String get tLongTapToFollowDeviceTheme => switch (_currentLocale) {
        SupportedLocale.en => 'Long Tap to follow Device theme',
        SupportedLocale.ar => 'اضغط لفترة طويلة لمتابعة سمة الجهاز',
      };

  static String get tNowYouFollowDeviceTheme => switch (_currentLocale) {
        SupportedLocale.en => 'Now you follow Device theme',
        SupportedLocale.ar => 'أنت الآن تتبع سمة الجهاز',
      };

  static String get localeToolTip => switch (_currentLocale) {
        SupportedLocale.en => 'Language Menu',
        SupportedLocale.ar => 'قائمة اللغة',
      };

  static String localeDisplayName(LocaleSetting setting) => switch (setting) {
        LocaleSetting.auto => switch (_currentLocale) {
  ...
  static String tLoginMethodsDialogueContent(
    String email,
    List<String> methods,
...
//     };
  ...
  static String get tToastDefaultError => switch (_currentLocale) {
...
//       };
  ...
  static String get tAutomatic => switch (_currentLocale) {
        SupportedLocale.en => 'Automatic',
        SupportedLocale.ar => 'تلقائي',
      };

  static String get tLight => switch (_currentLocale) {
        SupportedLocale.en => 'Light',
        SupportedLocale.ar => 'مضيء',
      };

  static String get tDark => switch (_currentLocale) {
...
// static String get tPermissionScreenSubTitle => switch(currentLocale {SupportedLocale.en=>tPermissionScreenSubTitle,SupportedLocale.ar => throw UnimplementedError(),};
  ...
  static String get tAllow => switch (_currentLocale) {
        SupportedLocale.en => 'Allow',
        SupportedLocale.ar => 'سماح',
      };

  static String get tRefresh => switch (_currentLocale) {
  ...
  static String get tLabelEmail => switch (_currentLocale) {
  ...
  /// Home Screen
  static String get tHomePageTitle => switch (_currentLocale) {
...
// Booked
  ...
  static String get tCancel => switch (_currentLocale) {
        SupportedLocale.en => 'Cancel',
        SupportedLocale.ar => 'إنهاء',
      };

  static String get tDismiss => switch (_currentLocale) {
        SupportedLocale.en => 'Dismiss',
        SupportedLocale.ar => 'تجاهل',
      };
...
// Filter UI
  ...
  static String get tPermissionDenied => switch (_currentLocale) {
        SupportedLocale.en => 'Permission Denied',
        SupportedLocale.ar => 'الإذن غير مسموح به',
      };

  static String get tSettings => switch (_currentLocale) {
        SupportedLocale.en => 'Settings',
        SupportedLocale.ar => 'الضبط',
      };

  static String get tMicrophoneReason => switch (_currentLocale) {
        SupportedLocale.en => 'record voice messages',
        SupportedLocale.ar => 'تسجيل رسائل صوتية',
      };

  static String get tCameraReason => switch (_currentLocale) {
        SupportedLocale.en => 'take a picture',
        SupportedLocale.ar => 'التقاط صورة',
      };

  static String get tPhotosReason => switch (_currentLocale) {
        SupportedLocale.en => 'pick a photo',
        SupportedLocale.ar => 'الاختيار من الصور',
      };

  static String get tLocationAlwaysReadableName => switch (_currentLocale) {
        SupportedLocale.en => 'Background Location Access',
        SupportedLocale.ar => 'الوصول للموقع في الخلفية',
      };

  static String get tLocationAlwaysReason => switch (_currentLocale) {
  ...
  static String permissionRequestMessage(String readableName, String reason) => switch (_currentLocale) {
        SupportedLocale.en => '$readableName permission is required to $reason.',
        SupportedLocale.ar => 'إذن $readableName مطلوب من أجل $reason.'
      };

  static String permissionSettingMessage(String readableName, String reason) => switch (_currentLocale) {
        SupportedLocale.en =>
...
// static String get int settingsPageIndex => switch(currentLocale {SupportedLocale.en=>settingsPageIndex,SupportedLocale.ar => throw UnimplementedError(),};
  ...
  static String get tPrivacyPolicy => switch (_currentLocale) {
        SupportedLocale.en => 'Privacy Policy',
        SupportedLocale.ar => 'سياية الخصوصية',
      };

  /// Terms of Use Screen
  static String get tTermsOfUse => switch (_currentLocale) {
        SupportedLocale.en => 'Terms of Use',
        SupportedLocale.ar => 'بنود الاستخدام',
      };

  /// Contact Us Screen
  static String get tContactUs => switch (_currentLocale) {
  ...
  /// About Screen
  static String get tAbout => switch (_currentLocale) {
