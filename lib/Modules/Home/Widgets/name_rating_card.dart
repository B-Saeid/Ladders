...
import '../../../Shared/Services/Routing/routes.dart';
...
class NameAndImage extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) => CardWell(
        onPressed: () => InAppHelpers.adaptiveDrawerNavigation(
          context,
